...
%><p>
          ...
          <div id="Demo2" class="w3-hide w3-container">
            <%
        try{    int deal=0,total=0,price=0;
    		...
    		PreparedStatement st= null;
    			...
    			String qry="select * from estimate where source=? and dest=? and mode=?";
    			...
    			while(result.next())
    			{
    				int dist=Integer.parseInt(result.getString("distance"));
    				price=Integer.parseInt(result.getString("price"));
    				out.print("<p>Distance:"+dist+"km--> Rs."+price+"/-</p>");

    			}
    			if(session.getAttribute("offer").equals("silver"))
    			{deal=15*1200;
    			out.print("<p>Offer Price--> Rs,"+deal+"/-</p>");}
    			if(session.getAttribute("offer").equals("gold"))
    			{deal=30*1400;
    			out.print("<p>Offer Price--> Rs,"+deal+"/-</p>");}
    			if(session.getAttribute("offer").equals("platinum"))
    			{deal=40*2000;
    			out.print("<p>Offer Price--> Rs"+deal+"/-</p>");}
    			total=deal+price;
    			out.print("<p>Total --> Rs."+total+"/-</p>");
        }
            catch (Exception e) {
        		e.printStackTrace();
          }
